...
export function ProductCard({ product, onViewDetails }: ProductCardProps) {
    ...
    return (
        <motion.article
            ...
            className="group cursor-pointer overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/80 p-5 shadow-xl shadow-black/20"
        ...
        >
            <div className="relative overflow-hidden rounded-[1.5rem] bg-slate-800">
                ...
                <div className="absolute left-4 top-4 flex flex-wrap gap-2">
                    {product.badges.map((badge) => (
                        <span
                            key={badge}
                            className="rounded-full bg-white/10 px-3 py-1 text-[0.65rem] uppercase tracking-[0.2em] text-slate-100"
                        >
                            {badge}
                        </span>
                    ))}
            ...
            <div className="mt-5 space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm leading-6 text-slate-400 line-clamp-2">{product.description}</p>
                </div>
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="rounded-full bg-white/5 px-3 py-1 text-[0.75rem] uppercase tracking-[0.2em] text-slate-300">
